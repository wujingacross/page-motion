  ...
  return (
    ...
    >
      ...
      <AvatarGroupTooltipArrowPrimitive
        className="fill-primary size-3 data-[side='bottom']:translate-y-px data-[side='right']:translate-x-px data-[side='left']:translate-x-px data-[side='top']:translate-y-1px"
        tipRadius={2}
      />
    </AvatarGroupTooltipPrimitive>
  );
